...
// P: Two parameters one is the number of classmates. The other is the number of pages. 
// Working with positve integers

//R: The result should be a multiplication of both n and m if both are greater than zero.
